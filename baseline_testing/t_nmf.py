...
def main():
    ...
    n_factor = 100  # Number of factors for NMF, you can adjust this value as needed
    ...
    nmf_model = NMF(n_user=len(customers_train_set), n_item=len(items), n_factor=n_factor)
    nmf_model.build_model(all_customers_baskets)
    ...
    for customer_id in customers_train_set:
        ...
        for next_basket_id in next_baskets:
            print(customer_id - 1, "\n")
            pred_basket = model.predict(user_id= i)
