...
def main():
    ...
    for customer_id in list(customers_train_set.keys()):
        ...
        customers_recsys[customer_id] = clf
    ...
    for customer_id in customers_train_set:
            ...
            clf = customers_recsys[customer_id]
